...
export let routes = [
    {tag:'li', path: '/', html: '<img class="img-logo" alt="logo" src="./../../img/logo.svg"></img>', classes:['link'], component: HomeContainer},   
    ...
    // {tag: 'div', path: 'cart', html: `${count.value}`, classes: ['number-of-purchases']}
];